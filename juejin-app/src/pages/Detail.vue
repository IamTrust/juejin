...
.page__header{
    width: 100%;
    height: 60px;
    background: rgba(144, 243, 78, 0.171);
}
...
.article-main{
    width: 100%;
    height: 600px;
    /* background: rgba(61, 155, 231, 0.219); */
    margin: 0 auto;
    display: flex;
...
.form-box>textarea:focus-within{
    outline: 1px solid var(--juejin-brand-1-normal); 
}
.form-box:focus-within .action-box{
    display: flex;
}
.action-box{
    height: 36px;
...
.comment-action-box div{
    display: flex;
    align-items: center;
    margin-right: 15px;
}
.comment-action-box img{
    width: 16px;
    height: 16px;
    margin-right: 5px;
}
...
.sidebar{
    ...
    height: 600px;
    flex: 1;
    /* background: rgba(146, 231, 77, 0.63); */
    /* background: #fff; */
